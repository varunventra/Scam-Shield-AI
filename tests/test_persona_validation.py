...
class TestPersonaRealism:
    ...
    def test_06_indian_english_patterns(self):
        """Should use Indian English patterns naturally"""
        # Note: This is a soft check - not all responses will have these
        indian_patterns = [
            "no", "only", "yaar", "beta", "what is this",
            "why you", "tell me no", "is it"
        ]
    ...
    def test_07_expresses_vulnerability(self):
        """Should show natural vulnerability of elderly person"""
        vulnerability_phrases = [
            "alone", "grandson", "granddaughter", "don't have much",
            "not sure", "help me", "don't know", "confused"
        ]
    ...
    def test_09_extracts_scammer_info_naturally(self):
        """Should naturally ask for scammer's information"""
        extract_questions = [
            "who are you", "what is your name", "where you calling from",
            "employee id", "office phone", "which bank"
        ]
