...
def run_remote_tests(base_url, api_key):
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            print("  • Intelligence extraction (9 types: bank accounts, UPI IDs,")
            print("    phones, emails, amounts, employee IDs, links, impersonation targets)")
            print("  • Strategic 3-phase extraction (build trust → gradual → comfortable)")
            print("  • Agent proactive information gathering")
